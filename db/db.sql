...
Insert into user_details(001,'admin','admin123','RVCE','12345678','admin@gmail.com')
...
CREATE TABLE SENSOR_VALUE (DEVICE_ID VARCHAR(20),SLAVE_ID VARCHAR(10),REG_ADD VARCHAR(10),VALUE FLOAT, U_TIME TIMESTAMP,PRIMARY KEY (DEVICE_ID, SLAVE_ID, REG_ADD, U_TIME),FOREIGN KEY (DEVICE_ID, REG_ADD, SLAVE_ID) REFERENCES SENSOR_PARAMETERS(DEVICE_ID, REG_ADD, SLAVE_ID));
...
ADD COLUMN d_time VARCHAR(20);

Alter table todo add column end_date DATE;
